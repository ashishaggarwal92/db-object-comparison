...
@Component("test.job1.compare.table.object.pk.tasklet")
@StepScope
public class TableObjectPKCompareTasklet implements Tasklet {

	private static final Logger LOGGER = LoggerFactory.getLogger(TableObjectPKCompareTasklet.class);
	...
	private static final String OBJECT_NAME = "TABLE_PRIMARY_KEY";
