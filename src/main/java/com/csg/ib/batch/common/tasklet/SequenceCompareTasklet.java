...
@Component("test.job1.compare.sequence.tasklet")
@StepScope
public class SequenceCompareTasklet implements Tasklet {

	private static final Logger LOGGER = LoggerFactory.getLogger(SequenceCompareTasklet.class);
	...
	@Value("${enable.matching.sequence}")
	...
	private static final String OBJECT_NAME = "SEQUENCE";
