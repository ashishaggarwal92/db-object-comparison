...
@Component("test.job1.compare.function.tasklet")
@StepScope
public class FunctionCompareTasklet implements Tasklet {

	private static final Logger LOGGER = LoggerFactory.getLogger(FunctionCompareTasklet.class);
	...
	@Value("${enable.matching.function}")
	...
	private static final String OBJECT_NAME = "FUNCTION";
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		...
		if (enabled) {
			List<String> objects1 = DbConnectionUtil.getAllFunctions(dbConnection1, userName1);
			List<String> objects2 = DbConnectionUtil.getAllFunctions(dbConnection2, userName2);
