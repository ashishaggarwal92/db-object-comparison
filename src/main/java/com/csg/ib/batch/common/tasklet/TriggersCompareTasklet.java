...
@Component("test.job1.compare.trigger.tasklet")
@StepScope
public class TriggersCompareTasklet implements Tasklet {

	private static final Logger LOGGER = LoggerFactory.getLogger(TriggersCompareTasklet.class);
	...
	private static final String OBJECT_NAME = "TRIGGER";
