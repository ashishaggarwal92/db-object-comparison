...
@Component("test.job1.compare.stored.procedure.tasklet")
@StepScope
public class StoredProcedureCompareTasklet implements Tasklet {

	private static final Logger LOGGER = LoggerFactory.getLogger(StoredProcedureCompareTasklet.class);
	...
	@Value("${enable.matching.stored.procedure}")
	...
	private static final String OBJECT_NAME = "PROCEDURE";
